    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <a href="https://www.webmotors.com.br/sedans" target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit  rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg">Ver mais</a>
        </div>

        <div className="bg-green p-12">
          <img src={iconSuvs} alt="ícone de carros suvs" className="mb-7"/>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          <img src={iconLuxury} alt="ícone de carros luxo" className="mb-7"/>
          ...
          <a href="https://www.webmotors.com.br/carros-de-luxo" target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit  rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg">Ver mais</a>
        </div>
      </section>
    </main>
  )
